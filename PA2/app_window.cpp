...
void AppWindow::glutKeyboard ( unsigned char key, int x, int y )
 {
   switch ( key )
    { case ' ': _viewaxis = !_viewaxis; redraw(); break;
	  ...
	  case 'w': _capsule.changed = true; rt += rtChange; redraw(); break;
	  case 's': _capsule.changed = true; rt -= rtChange; redraw(); break;
	  case 'e': _capsule.changed = true; rb += rbChange; redraw(); break;
	  case 'd': _capsule.changed = true; rb -= rbChange; redraw(); break;
